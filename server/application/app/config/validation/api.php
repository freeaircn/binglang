 ...
 * @LastEditors: freeair
 * @LastEditTime: 2021-02-25 11:12:02
 */
...
$config['email'] = [
    'field' => 'email',
    'rules' => 'required|regex_match[/^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/]',
];
...
$config['verification_code'] = [
    'field' => 'code',
    'rules' => 'required|regex_match[/^[0-9]{1,10}$/]',
];

$config['username'] = [
    'field' => 'username',
    // 'rules' => 'required|regex_match[/^([\u4e00-\u9fa5]){0,15}$/]',
    'rules' => 'required|regex_match[/^([\x{4e00}-\x{9fa5}]{1,15})$/u]',
];
...
$config['identity_document_number'] = [
    'field' => 'identity_document_number',
    'rules' => 'regex_match[/^([1-9]\d{5}(18|19|20|(3\d))\d{2}((0[1-9])|(1[0-2]))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]){0,1}$/]',
];
...
$config['account_security_prop'] = [
    'field' => 'prop',
    'rules' => 'required|in_list[phone,email]',
];
