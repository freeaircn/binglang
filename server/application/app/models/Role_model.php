 ...
 * @LastEditors  : freeair
 * @LastEditTime : 2020-01-15 19:55:05
 */
...
class Role_model extends CI_Model {
    ...
    {
		$this->db->insert($this->tables['role'], $data);
    ...
    {
		$this->db->where('id', $id);
		$this->db->update($this->tables['role'], $data);
    ...
    {
		// $result = $this->db->where_in('id', $ids)->delete($this->tables['role']);
		$result = $this->db->where('id', $id)->delete($this->tables['role']);
