<template>
  <div class="find-pwd-wrapper">
    <div class="find-pwd-container mb-4">
      ...
      <el-form ref="findPwdForm" :model="findPwdForm" :rules="findPwdRules" class="container-sm px-responsive" label-position="left">
        <el-form-item ref="phone" prop="phone">
          <el-input ref="phone_input" v-model="findPwdForm.phone" name="phone" type="text" tabindex="1" prefix-icon="el-icon-mobile-phone" :disabled="isValidCode" placeholder="输入注册的手机号" clearable />
        </el-form-item>

        <el-form-item ref="verificationCode" prop="verificationCode">
          <el-input v-model="findPwdForm.verificationCode" type="text" prefix-icon="el-icon-copy-document" class="code-field" name="verificationCode" :disabled="isValidCode" placeholder="输入验证码" clearable />
          <input v-model="btnReqCodeText" :disabled="isBtnDisable || isValidCode" type="button" class="btn-code" @click="handleRequestCode">
        </el-form-item>

        <el-form-item v-show="isValidCode === true" ref="newPassword" prop="newPassword">
          <el-input v-model="findPwdForm.newPassword" name="newPassword" type="text" prefix-icon="el-icon-lock" placeholder="输入新密码" show-password clearable />
        </el-form-item>

        <el-form-item v-show="isValidCode === true" ref="newPassword2" prop="newPassword2">
          <el-input v-model="findPwdForm.newPassword2" name="newPassword2" type="text" prefix-icon="el-icon-lock" placeholder="重新输入新密码" show-password clearable />
        </el-form-item>
